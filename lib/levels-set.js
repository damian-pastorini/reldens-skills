...
class LevelsSet
{
    ...
    async init(props)
    {
        ...
        this.autoFillRanges = sc.getDef(props, 'autoFillRanges', false);
        this.autoFillExperienceMultiplier = sc.getDef(props, 'autoFillExperienceMultiplier', 1.5);
        this.currentLevel = sc.getDef(props, 'currentLevel', 0);
        this.currentExp = sc.getDef(props, 'currentExp', 0);
        ...
        this.increaseLevelsWithExperience = sc.getDef(props, 'increaseLevelsWithExperience', true);
        // unless specified, levels by experience must just be sorted by their key attribute (without auto-fill):
        this.levelsByExperience = sc.getDef(props, 'levelsByExperience', this.sortLevelsBy(this.levels));
