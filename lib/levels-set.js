...
class LevelsSet
{
    ...
    init(props)
    {
        ...
        this.fireEvent(SkillsEvents.INIT_LEVEL_SET_START, this);
        ...
        this.levelsByExperience = sc.hasOwn(props, 'levelsByExperience') ?
            props.levelsByExperience : this.sortLevelsBy(this.levels);
        this.fireEvent(SkillsEvents.INIT_LEVEL_SET_END, this);
    }
    ...
    setLevels(levels)
    {
        ...
        this.fireEvent(SkillsEvents.SET_LEVELS, this, levels);
        return this.levels;
    }
    ...
    levelUp()
    {
        ...
        this.fireEvent(SkillsEvents.LEVEL_UP, this);
    }
    ...
    levelDown()
    {
        ...
        this.currentLevel--;
        this.fireEvent(SkillsEvents.LEVEL_DOWN, this);
    }
    ...
    applyLevelModifiers(revert)
    {
        ...
        this.fireEvent(SkillsEvents.LEVEL_APPLY_MODIFIERS, this, currentLevelInstance);
    ...
    addExperience(number)
    {
        ...
        this.fireEvent(SkillsEvents.LEVEL_EXPERIENCE_ADDED,
            this,
            number,
            newTotalExp,
            currentLevelIndex,
