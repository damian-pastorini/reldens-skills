...
class PhysicalAttack extends Attack
{
    ...
    {
        super(props);
        this.type = SkillConst.SKILL_TYPE_PHYSICAL_ATTACK;
        ...
        if(typeof props.owner.executeOnHit !== 'function'){
            ErrorManager.error('Missing executeOnHit required method. The method should call the skill.onHit().');
        }
    ...
    async onHit(hitData)
    {
        this.events.emit('reldens.skills.physicalAttackOnHit', this, hitData);
