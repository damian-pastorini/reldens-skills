...
class PhysicalAttack extends Attack
{
    ...
    {
        super(props);
        this.type = SkillsConst.SKILL.TYPE.PHYSICAL_ATTACK;
        this.parentType = SkillsConst.SKILL.TYPE.ATTACK;
        this.isReady = PhysicalPropertiesValidator.validate(props);
        this.magnitude = props.magnitude;
        this.objectWidth = props.objectWidth;
        this.objectHeight = props.objectHeight;
        this.validateTargetOnHit = sc.get(props, 'validateTargetOnHit', false);
    ...
    {
        return PhysicalSkillRunner.executeOnHit(target, this, SkillsEvents.SKILL_PHYSICAL_ATTACK_HIT, async () => {
            return await super.runSkillLogic();
        });
    }
