...
class PhysicalEffect extends Effect
{
    ...
    {
        super(props);
        this.type = SkillsConst.SKILL.TYPE.PHYSICAL_EFFECT;
        this.parentType = SkillsConst.SKILL.TYPE.EFFECT;
    ...
    {
        return PhysicalSkillRunner.executeOnHit(target, this, SkillsEvents.SKILL_PHYSICAL_EFFECT_HIT, async () => {
