...
class Attack extends Skill
{
    ...
    constructor(props)
    {
        ...
        this.dodgeOverAimSuccess = {}.hasOwnProperty.call(props, 'dodgeOverAimSuccess') ? props.dodgeOverAimSuccess : 1;
    ...
    getPropertiesTotal(object, propertiesArray)
    {
        ...
        if(propertiesArray.length){
            // @TODO:
            //   - create a custom table for properties and make each property has it's own operation type:
            //     prop = {key: propName, op: ModifierConst.OP}
            //   - the use the calculator:
