...
class ModelsManager
{
    ...
    {
        return await this.getEntity('ownersClassPath').loadOneByWithRelations('owner_id', ownerId, '[owner_full_class_path]');
    }

    async updateLevel(levelsSet)
    {
        return await this.getEntity('ownersClassPath')
    ...
    async prepareClassPathInstancesList(classPathClasses)
    {
        ...
        let classPathModels = await this.getEntity('classPath').executeCustomQuery('fullPathData');
