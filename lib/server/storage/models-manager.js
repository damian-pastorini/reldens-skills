...
class ModelsManager
{
    ...
    async prepareSkillsInstancesList(skillsClasses)
    {
        ...
        let skillsModels = await this.models.skill.loadAll()
            .withGraphFetched('[skill_owner_conditions, skill_owner_effects]');
    ...
    async prepareClassPathData(owner, ownerIdProperty, classPathsListById, skillsClassesList)
    {
        ...
        // @TODO - BETA.17 - R1: temporal index 0 for one class path per player, we will have optional multiple classes.
    ...
    parseSkillsByLevels(levelSkillsModel, owner, ownerIdProperty, skillsClassesList)
    {
        ...
        for(let skillData of levelSkillsModel){
            ...
            if(sc.hasOwn(skillModel, 'skill_owner_conditions') && skillModel['skill_owner_conditions']){
            ...
            if(sc.hasOwn(skillModel, 'skill_owner_effects') && skillModel['skill_owner_effects']){
