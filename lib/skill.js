...
class Skill
{
    ...
    constructor(props)
    {
        ...
        // @TODO - BETA.17 - R3: include the following properties and behaviors for skills.
    ...
    async execute(target)
    {
        ...
        if(
            ...
            // @TODO - TEST: auto validation doesn't work with Reldens? ActionsMessageActions.parseMessageAndRunActions.
        ){
            return false;
        }
